<?php
	...
	class CashID
	{
		...
		private $domain = 'cashid.badgerwallet.cash';
		private $path = "/api/parse.php";

		// Credentials that grant access to a bitcoind RPC connection.
		private $rpc_username = 'yourrpcuser';
		private $rpc_password = 'yourrpcpass';
														...
														else
														{
															...
															else
															{
																...
																else
																{
																	...
																	{
																		$this->invalidate_request(self::STATUS_INVALID_SIGNATURE, "Signature verification failed: {$this->rpc_error}");
																	}
																	else
																	{
																		...
																		{
																			$this->invalidate_request(self::STATUS_INTERNAL_ERROR, "Internal server error, could not store response object.");
																		}
																		else
																		{
																			...
																			{
																				$this->invalidate_request(self::STATUS_INTERNAL_ERROR, "Internal server error, could not store confirmation object.");
																			}
																			else
																			{
